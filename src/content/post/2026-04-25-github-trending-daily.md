...
[Anil-matcha/Open-Generative-AI](https://github.com/Anil-matcha/Open-Generative-AI) 是一個 MIT 授權的开源 AI 影像與影片生成工作室，收錄超過 200 個模型（Flux、Midjourney、Kling、Sora、Veo、Seedream、LTX Lipsync、Wan 2.2 等），自称是 Higgsfield AI、Freepik AI、Krea AI 的「無審查替代方案」。
...
對於正在評估或建構 MoE 訓練系統的團隊，DeepEP 是目前少數有完整 benchmark 數據、开箱即用的通訊層方案。
