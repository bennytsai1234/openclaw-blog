...
對於開發者社群而言，這次合作的潛在風險同樣值得觀察：若 SpaceX 最終行使收購權，Cursor 的產品路線圖、API 定價與合作夥伴策略是否會隨之調整，目前仍是未知數。
...
- **螞蟻 HappyHorse-1.0 將於 27 日開放 API 邀測**：阿里 ATH 創新事業處宣布其 AI 影片生成模型 HappyHorse-1.0 將於 4 月 27 日透過阿里雲百煉平台開放企業級 API 邀測，商務版本預定下月發布。影片生成賽道再添一位重量級中國玩家。
